...
export const DEFAULT_TRANSLATIONS: Record<string, TranslationDictionary> = {
  es: {
    // Header & Navigation
    "app.title": "PELIGROSO TRUCO",
    "app.subtitle": "Selecciona un modo competitivo para comenzar",
    "app.leave": "← Salir de la partida",
    "app.account": "Cuenta y Perfil",
    "app.admin": "Consola Admin",

    // Lobby Game Modes
    "mode.ai": "Práctica 1v1 vs Bot (Solo)",
    "mode.local": "2v2 Modo Local (Paso a Paso)",
    "mode.online": "Partida Competitiva Servidor",
    ...
    "active_session.desc": "Te desconectaste o recargaste la página. Haz clic abajo para reconectarte.",
    "active_session.rejoin": "Reconectarse a la Partida",
    ...
    // Game Table Status
    "table.your_turn": "TU TURNO (Jugador {id}) — Arrastra o selecciona una carta",
    "table.waiting": "Esperando al Jugador {id}...",
    "table.drop_here": "Suelta la carta aquí para jugar",
    "table.opponent_cards": "Cartas jugadas por el oponente (Jugador {id}):",
    "table.your_cards": "Cartas jugadas por ti:",
    "table.your_hand": "Tu Mano (Puntos de Envido: {score})",
    "table.history": "Historial de Partida",
    "table.arena": "Arena: Mat de {name}",
    ...
    "social.audio_muted": "Salida Audio: Silenciada",
    "social.audio_active": "Salida Audio: Activa",
    ...
    "social.send": "Enviar",
    "social.placeholder": "Escribe un mensaje...",
    "social.live_chat": "Chat Global del Lobby",
    ...
    "profile.country_label": "Seleccionar País (Código)",
    "profile.deck_label": "Seleccionar Tema del Mazo de Cartas",
    "profile.mat_preset_label": "Seleccionar Tapete de la Arena",
    "profile.mat_custom_label": "Subir Imagen de Tapete Personalizado",
    ...
    "profile.victory_music_label": "Himno de Victoria (URL Video YouTube)",
    "profile.victory_music_desc": "¡Reproduce 10 segundos de música de victoria al ganar!",
    "profile.victory_quote_label": "Lema / Frase de Victoria",
    "profile.save": "Guardar Cambios",

    // Leaderboard & Matchmaking Queue
    "leaderboard.title": "Clasificación Global & Top Players",
    "leaderboard.rank": "Puesto",
    "leaderboard.player": "Jugador",
    "leaderboard.elo": "Rating ELO",
    "leaderboard.win_rate": "Porcentaje Victorias",
    ...
    // Admin Console
    "admin.console_title": "Consola de Administración",
  ...
  en: {
    // Header & Navigation
    "app.title": "PELIGROSO TRUCO",
    "app.subtitle": "Select a competitive game mode to start playing",
    "app.leave": "← Leave Match",
    "app.account": "Account & Profile",
    "app.admin": "Admin Console",

    // Lobby Game Modes
    "mode.ai": "1v1 Practice vs AI Bot (Solo)",
    "mode.local": "2v2 Local Match (Pass & Play)",
    "mode.online": "Competitive Server Match",
    ...
    // Active Session Reconnection Banner
    "active_session.title": "Match In Progress (Match #{id})",
    "active_session.desc": "You were disconnected or refreshed. Click rejoin below to return.",
    ...
    // Game Table Status
    "table.your_turn": "YOUR TURN (Player {id}) — Select or drag a card to play!",
    "table.waiting": "Waiting for Player {id}...",
    "table.drop_here": "Drop card here to play!",
    "table.opponent_cards": "Opponent (Player {id}) Cards Played:",
    "table.your_cards": "Cards Played by You:",
    "table.your_hand": "Your Hand (Envido Score: {score})",
    "table.history": "Game History",
    "table.arena": "Arena: {name}'s Mat",
    ...
    "social.live_chat": "Global Lobby Chat",
    ...
    "profile.mat_preset_label": "Select Arena Mat Surface",
    "profile.mat_custom_label": "Upload Custom Arena Mat Image",
    ...
    // Admin Console
    "admin.console_title": "Admin Management Console",
