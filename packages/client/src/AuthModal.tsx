          ...
          >
            <div>
              <div style={{ fontWeight: "bold", color: "#f59e0b", fontSize: "0.95rem" }}>
                {getCountryFlag(profile.country_code, profile.is_guest)} {profile.username} {profile.role === "admin" && <span style={{ fontSize: "0.6rem", background: "rgba(245, 158, 11, 0.2)", border: "1px solid #f59e0b", color: "#f59e0b", padding: "1px 5px", borderRadius: "4px", marginLeft: "6px" }}>ADMIN</span>}
              </div>
